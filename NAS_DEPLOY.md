...
Release 0.4.0 использует:

```sh
CONFIRM_STAGE13_DEPLOY=true sh scripts/deploy_stage13.sh
```

Следующая версия должна иметь обновлённый version-specific deploy evidence.
