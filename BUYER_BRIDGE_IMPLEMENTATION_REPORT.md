...
`SecretStorage 3.5.0`, `jeepney 0.9.0` and runtime dependency `uvloop 0.22.1`; this prevents a
Windows-generated hash lock from omitting packages required by Linux CI and buyer hosts.
