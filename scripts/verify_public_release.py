...
async def run(base_url: str) -> None:
    ...
    assert info.status_code == 200 and info_data["version"] == "0.3.0"
    ...
    assert status_data["free_mcp_tools"] == ["catalog_search", "demo_url_pulse"]
    ...
    assert card.status_code == 200 and server_info["version"] == "0.3.0"
    assert len(tools) == 34
    ...
    print("public_release=PASS; version=0.3.0; paid_tools=32; free_tools=2")
